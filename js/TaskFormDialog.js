...
(function (scope) {
    ...
    TaskFormDialog.prototype = Object.create(BasicFormDialog.prototype);
    TaskFormDialog.prototype.constructor = TaskFormDialog;
    ...
    scope.TaskFormDialog = TaskFormDialog;
}(window));
